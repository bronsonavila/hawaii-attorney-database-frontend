...
export const LAST_UPDATED = '2/28/2026'
...
export const METADATA = {
  ...
  author: { name: 'Bronson Avila', url: 'https://www.bronsonavila.com/' },
  citation: { name: 'Hawaii State Bar Association', url: 'https://hsba.org/' },
  description:
